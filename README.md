...
* [FireHOL](https://firehol.org/) - A human readable stateful iptables firewall builder.
...
* [OPNsense](https://www.opnsense.org/) - Modern Firewall distribution, fork of pfSense.
